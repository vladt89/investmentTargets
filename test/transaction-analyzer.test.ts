        ...
        expect(analyzeResult).toEqual([{
            "diagram": {
                ...
                "food": {
                    ...
                    "percentage": 1,
                    "topTransactions": {
                        "1": "spent 27 euros in ALEPA MALMINKARTANO on Mon Oct 10 2022",
                        "2": "spent 10 euros in K-supermarket Konala on Mon Oct 10 2022",
                        "3": "spent 5 euros in ALEPA MALMINKARTANO on Mon Oct 10 2022"
                    }
                },
                "houseAndFurniture": {
                    "amount": "963",
                ...
                "other": {
                    ...
                    "topTransactions": {
                        ...
                        "2": "spent 5 euros in Motonet Helsinki, Konala on Mon Oct 10 2022",
                        "3": "spent  euros in APPLE.COM/BILL on Mon Oct 10 2022"
                    }
                },
                "sportEatFun": "10 euros (0%)",
                "sum": "2541 euros",
                "travel": "1189 euros (46%)"
            },
            "month": "October 2022"
        }]);
    });
